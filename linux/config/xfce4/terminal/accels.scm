...
(gtk_accel_path "<Actions>/terminal-window/next-tab" "<Primary>braceright")
(gtk_accel_path "<Actions>/terminal-window/goto-tab-1" "<Alt>1")
(gtk_accel_path "<Actions>/terminal-window/show-menubar" "<Primary><Shift>b")
...
(gtk_accel_path "<Actions>/terminal-window/fullscreen" "<Primary><Super>f")
; (gtk_accel_path "<Actions>/terminal-window/detach-tab" "<Primary><Shift>d")
(gtk_accel_path "<Actions>/terminal-window/prev-tab" "<Primary>braceleft")
(gtk_accel_path "<Actions>/terminal-window/move-tab-left" "<Primary><Super>braceleft")
...
(gtk_accel_path "<Actions>/terminal-window/show-borders" "<Primary><Shift>g")
...
(gtk_accel_path "<Actions>/terminal-window/move-tab-right" "<Primary><Super>braceright")
(gtk_accel_path "<Actions>/terminal-window/goto-tab-9" "<Alt>9")
(gtk_accel_path "<Actions>/terminal-window/goto-tab-5" "<Alt>5")
(gtk_accel_path "<Actions>/terminal-window/set-title" "<Primary><Alt>t")

...
echo ""
cecho "###############################################" $cyan
cecho "#             OS X FOR HACKERS                #" $cyan
cecho "#            fork by Drew Lustro              #" $cyan
cecho "###############################################" $cyan
echo ""
cecho "===============================================" $yellow
cecho "=        DO NOT RUN THIS SCRIPT BLINDLY       =" $yellow
cecho "=         YOU'LL PROBABLY REGRET IT...        =" $yellow
cecho "=                                             =" $yellow
cecho "=              READ IT THOROUGHLY             =" $yellow
cecho "=         AND EDIT TO SUIT YOUR NEEDS         =" $yellow
cecho "===============================================" $yellow
echo ""
...
echo ""
echo "Set Dock to auto-hide and reduce the auto-hiding delay (0.5s)? (y/n)"
read -r response
case $response in
  [yY])
...
echo ""
echo "Make Dock icons of hidden applications translucent? (y/n)"
read -r response
case $response in
  [yY])
...
case $response in
  [yY])
    ...
    mkdir $HOME/Torrents 2> /dev/null

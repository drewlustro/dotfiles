...
[showrepaint]
s0_toggle_key = <Control><Alt><Super>Scroll_Lock
s0_intensity = 50
...
s0_lock_screen = <Control><Alt><Super>Break
...
[mblur]
s0_initiate_key = <Control><Alt><Super>End
s0_mode = 0
s0_strength = 2.000000
...
s0_next_no_popup_button = Disabled
s0_next_no_popup_key = <Control>Tab
s0_prev_no_popup_button = Disabled
s0_prev_no_popup_key = <Shift><Control>Tab
s0_next_panel_button = Disabled
s0_next_panel_key = Disabled
s0_prev_panel_button = Disabled
s0_prev_panel_key = Disabled
...
s0_selection_fill_color = #2f2f4f2e
s0_directory = 
s0_launch_app = 
